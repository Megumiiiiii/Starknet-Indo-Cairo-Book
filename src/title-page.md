...
Versi teks ini diasumsikan Anda menggunakan [Penerjemah Cairo](https://github.com/starkware-libs/cairo) [versi 2.2.0](https://github.com/starkware-libs/cairo/releases). Lihat bagian "Instalasi" dari Bab 1 untuk menginstal atau memperbarui Cairo.
